...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const savedTheme = localStorage.getItem('skillfy-theme');
    ...
    themeToggle.addEventListener('click', () => {
        ...
        localStorage.setItem('skillfy-theme', next);
    ...
    window.matchMedia('(prefers-color-scheme: dark)').addEventListener('change', (e) => {
        if (!localStorage.getItem('skillfy-theme')) {
    ...
    filterBtns.forEach(btn => {
        btn.addEventListener('click', () => {
            ...
            setTimeout(() => {
                ...
                toShow.forEach(card => {
                    card.classList.remove('card-collapsed', 'card-hidden');
                    card.style.transitionDelay = '0ms';
                });
    ...
    projectCards.forEach(card => card.classList.add('card-visible'));
